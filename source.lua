--there alot messy stuff here so dont ask why there so many unnecessary line
...
getgenv().__ = 'Lynix'
getgenv().___ = 'Ticxyy'
local NotifyLibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/ilyanaes/deleted-chairs/main/NotificationLibrary"))()
getgenv().ScriptName = 'ThunderZ V4 Stand Beta'
...
Notify({Title = "Already Executed!",Duration = 5})
Notify({Title = "Already Executed!",Duration = 5})
Notify({Title = "Already Executed!",Duration = 5})return end
...
Notify({Title =  "['Owner'] = '"..StandOwner.."',",Duration = 30})return end
Notify({Title = "The execution might be slow",Duration = 30})
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/ilyanaes/deleted-chairs/main/CreateScript"))()
Notify({Title = "Function Loaded",Duration = 30})
loadstring(game:HttpGet("https://raw.githubusercontent.com/ilyanaes/deleted-chairs/main/xxx"))()
Notify({Title = "Block remote loaded",Duration = 30})
ANIMATION()
Notify({Title = "Animation loaded",Duration = 30})
...
Create("Owner!",function()
    Chat('Join server To Buy script')
    wait(.1)
    Chat('.gg/VrX94nJjdx')
    wait(.1)
    Chat('If you have issues dm "me1al0ne/faisal8754"')
end)
...
CreateTargetAbility("ModeV3!",function()
    if TARGET then
...
Notify({Title = ScriptName.." Loaded",Description ="Made By faisal8754/the.silly.cat/flow",Duration = 3.4028235e+38})
Notify({Title = "Added V3! its best one",Duration = 60})
Notify({Title = "So Thanks For Buying our script",Duration = 60})
Notify({Title = "Gstomp cmd fixed",Duration = 60})
Notify({Title = "Double reload fixed",Duration = 60})
loadstring(game:HttpGet("https://raw.githubusercontent.com/ilyanaes/sdtand-script/main/security"))()
